...
var init_define_process = __esm({
  "<define:process>"() {
    env = { NODE_ENV: "development", VERSION: "2022-01-24T20:56:58.233Z" };
...
var require_react = __commonJS({
  "node_modules/react/index.js"(exports, module) {
    ...
    "use strict";
    if (define_process_default.env.NODE_ENV === "production") {
      module.exports = __require("./cjs/react.production.min.js");
    } else {
...
var require_server_browser = __commonJS({
  "node_modules/react-dom/server.browser.js"(exports, module) {
    ...
    "use strict";
    if (define_process_default.env.NODE_ENV === "production") {
      module.exports = __require("./cjs/react-dom-server.browser.production.min.js");
    } else {
...
var import_server2 = __toModule(require_server_browser());
...
B.Push = "PUSH";
B.Replace = "REPLACE";
var C = define_process_default.env.NODE_ENV !== "production" ? function(b) {
...
function warningOnce(key, cond, message) {
  if (!cond && !alreadyWarned[key]) {
    ...
    define_process_default.env.NODE_ENV !== "production" ? warning(false, message) : void 0;
  }
}
...
function Router(_ref3) {
  ...
  !!useInRouterContext() ? define_process_default.env.NODE_ENV !== "production" ? invariant(false, "You cannot render a <Router> inside another <Router>. You should never have more than one in your app.") : invariant(false) : void 0;
  ...
  define_process_default.env.NODE_ENV !== "production" ? warning(location != null, '<Router basename="' + basename + '"> is not able to match the URL ' + ('"' + pathname + search + hash + '" because it does not start with the ') + "basename, so the <Router> won't render anything.") : void 0;
  if (location == null) {
    return null;
  }
...
function useHref(to) {
  !useInRouterContext() ? define_process_default.env.NODE_ENV !== "production" ? invariant(false, "useHref() may be used only in the context of a <Router> component.") : invariant(false) : void 0;
  let {
    basename,
    navigator
...
function useLocation() {
  !useInRouterContext() ? define_process_default.env.NODE_ENV !== "production" ? invariant(false, "useLocation() may be used only in the context of a <Router> component.") : invariant(false) : void 0;
  return (0, import_react.useContext)(LocationContext).location;
}
function useNavigate() {
  !useInRouterContext() ? define_process_default.env.NODE_ENV !== "production" ? invariant(false, "useNavigate() may be used only in the context of a <Router> component.") : invariant(false) : void 0;
  let {
    basename,
    navigator
  } = (0, import_react.useContext)(NavigationContext);
  ...
  let navigate = (0, import_react.useCallback)(function(to, options) {
    ...
    define_process_default.env.NODE_ENV !== "production" ? warning(activeRef.current, "You should call navigate() in a React.useEffect(), not when your component is first rendered.") : void 0;
...
function useRoutes(routes3, locationArg) {
  !useInRouterContext() ? define_process_default.env.NODE_ENV !== "production" ? invariant(false, "useRoutes() may be used only in the context of a <Router> component.") : invariant(false) : void 0;
  let {
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  if (locationArg) {
    ...
    !(parentPathnameBase === "/" || ((_parsedLocationArg$pa = parsedLocationArg.pathname) == null ? void 0 : _parsedLocationArg$pa.startsWith(parentPathnameBase))) ? define_process_default.env.NODE_ENV !== "production" ? invariant(false, "When overriding the location using `<Routes location>` or `useRoutes(routes, location)`, the location pathname must begin with the portion of the URL pathname that was " + ('matched by all parent routes. The current pathname base is "' + parentPathnameBase + '" ') + ('but pathname "' + parsedLocationArg.pathname + '" was given in the `location` prop.')) : invariant(false) : void 0;
  ...
  if (define_process_default.env.NODE_ENV !== "production") {
    define_process_default.env.NODE_ENV !== "production" ? warning(parentRoute || matches != null, 'No routes matched location "' + location.pathname + location.search + location.hash + '" ') : void 0;
    define_process_default.env.NODE_ENV !== "production" ? warning(matches == null || matches[matches.length - 1].route.element !== void 0, 'Matched leaf route at location "' + location.pathname + location.search + location.hash + '" does not have an element. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.') : void 0;
  }
...
function flattenRoutes(routes3, branches, parentsMeta, parentPath) {
  ...
  routes3.forEach((route, index) => {
    ...
    if (meta2.relativePath.startsWith("/")) {
      !meta2.relativePath.startsWith(parentPath) ? define_process_default.env.NODE_ENV !== "production" ? invariant(false, 'Absolute route path "' + meta2.relativePath + '" nested under path ' + ('"' + parentPath + '" is not valid. An absolute child route path ') + "must start with the combined path of all its parent routes.") : invariant(false) : void 0;
    ...
    if (route.children && route.children.length > 0) {
      !(route.index !== true) ? define_process_default.env.NODE_ENV !== "production" ? invariant(false, "Index routes must not have child routes. Please remove " + ('all child routes from route path "' + path + '".')) : invariant(false) : void 0;
...
function compilePath(path, caseSensitive, end) {
  ...
  define_process_default.env.NODE_ENV !== "production" ? warning(path === "*" || !path.endsWith("*") || path.endsWith("/*"), 'Route path "' + path + '" will be treated as if it were ' + ('"' + path.replace(/\*$/, "/*") + '" because the `*` character must ') + "always follow a `/` in the pattern. To get rid of this warning, " + ('please change the route path to "' + path.replace(/\*$/, "/*") + '".')) : void 0;
  let paramNames = [];
...
function safelyDecodeURIComponent(value, paramName) {
  try {
    ...
    define_process_default.env.NODE_ENV !== "production" ? warning(false, 'The value for the URL param "' + paramName + '" will not be decoded because' + (' the string "' + value + '" is a malformed URL segment. This is probably') + (" due to a bad percent encoding (" + error + ").")) : void 0;
    return value;
  }
}
...
// build/assets.json
var version = "9118c111";
var entry = {
  module: "/build/entry.client-QISKEHEY.js",
  imports: [
    "/build/_shared/chunk-OIGBEDEP.js",
...
var routes = {
  ...
  "routes/index": {
    ...
    parentId: "root",
    index: true,
    module: "/build/routes/index-I3KJLIVX.js",
    hasAction: false,
    hasLoader: false,
    hasCatchBoundary: false,
    hasErrorBoundary: false
...
var url = "/build/manifest-9118C111.js";
var assets_default = {
  version,
  entry,
  routes,
...
function handleRequest(request, responseStatusCode, responseHeaders, remixContext) {
  const markup = (0, import_server2.renderToString)(/* @__PURE__ */ React5.createElement(RemixServer, {
...
function createRequestHandler3({
  ...
  const platform = {};
  const handleRequest2 = createRequestHandler(build, platform, mode);
  return (request, env2, ctx) => {
    const requestUrl = new URL(request.url);
    if (requestUrl.hostname === "127.0.0.1") {
      requestUrl.hostname = "localhost";
      return redirect(requestUrl.toString());
    }
    const loadContext = typeof getLoadContext === "function" ? getLoadContext(request, env2, ctx) : void 0;
...
function createFetchHandler({
  ...
  const handleRequest2 = createRequestHandler3({
    build,
    getLoadContext,
    mode
  });
  const handleAsset = async (request, env2, ctx) => {
  ...
  return async (request, env2, ctx) => {
    try {
      const isHeadOrGetRequest = request.method === "HEAD" || request.method === "GET";
      const cache = typeof getCache !== "undefined" ? await getCache() : null;
      let response;
      if (isHeadOrGetRequest) {
        response = await handleAsset(request, env2, ctx);
      }
      if (response) {
        return response;
      }
      if (isHeadOrGetRequest) {
        response = await (cache == null ? void 0 : cache.match(request));
      }
      if (!response) {
        response = await handleRequest2(request, env2, ctx);
      }
      if (isHeadOrGetRequest) {
        ctx.waitUntil(cache == null ? void 0 : cache.put(request, response.clone()));
      }
      return response;
    } catch (e) {
      if (define_process_default.env.NODE_ENV === "development" && e instanceof Error) {
...
function newRequest(request, headerFn) {
...
var handleFetch = createFetchHandler({
  build: build_exports,
  getLoadContext(request, env2, context) {
    return {
      ...context,
